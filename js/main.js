$(function() {
  // Fixes pagination to top of page when user has scroll past a certain point
  initFixedPagination();
  // Initialize search bar to recognize Enter key press
  initSearchBar();
  // Handles logic for fetching next set of posts
    ...
    success: function(results) {
      ...
      // Else, no error response was returned!
        ...
        if (post_type == "likes") {
          ...
          total_posts = results.liked_count;
        ...
        var page_count = Math.ceil(total_posts / 10);
        ...
        for (var i = 0; i < num_posts; i++) {
          ...
          var date_posted = '<div class="date">' + "<h4>" + date + "</h4>" +
...
function search() {
  ...
  // Resets pagination to have page 1 selected
